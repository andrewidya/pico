...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.post_intro'
        db.alter_column(u'pico_blog_post', 'post_intro', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Post.post_intro'
        db.alter_column(u'pico_blog_post', 'post_intro', self.gf('django.db.models.fields.TextField')(default=False, max_length=255))
    ...
    models = {
        ...
        u'pico_blog.post': {
            ...
            'post_intro': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
